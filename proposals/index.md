...
- [AI 短影音工廠（批量產內容 → 流量變現）](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P001/) — 一句話腳本 → 自動產出帶配音、配樂、封面的成品短影音，規模化經營流量帳號。
- [GEO 內容帝國（搶 AI 搜尋流量）](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P002/) — AI 批量產內容、自動鋪設多站台，搶佔 Google 與 AI 引擎(被 ChatGPT/Perplexity 引用)的流量。
- [本機隱私版・可視化交易研究台（Mac App）](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P003/) — 全程在本機跑的多 agent 交易研究工具，看得到 AI 怎麼辯論決策，資料不出門。
- [Podcast/會議 → 帶人名逐字稿 + 多語配音 SaaS](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P004/) — 上傳音檔，自動產出標好發言人的逐字稿、多語翻譯與重新配音、社群封面。
- [本機數位人口播短影音工廠（真人感口播帳號）](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P005/) — 用你克隆的音色＋數位人，把一句選題自動變成「真人口播」短影音，量產知識型/帶貨帳號。
- [隱私版・本機文件智能 App（Mac，發票/合約/名片秒抽欄位）](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P006/) — 拖入文件，全程在本機 OCR＋結構化抽取＋摘要，資料不上雲——主打隱私的 Mac 生產力工具。
- [Claude Skill 策展包 + 本機 Skill 管理器（吃 skill 生態爆發紅利）](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P007/) — OSS Radar 每天幫你挑出爆紅的 Claude/OpenClaw skill，你品質篩選+繁中化打包成主題包賣，並配一個本機管理 App。
