...
- [AI 聯盟評測站群工廠：自動選品 → 多語評測長文 → 外鏈養站 → 佣金與斷鏈追蹤，一個人維運數十個聯盟收入站](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P053/) — 把聯盟行銷最耗人力的四件苦工（找可推的產品、寫出真的會被搜到的評測、建外部連結、追每個連結還有沒有在賺錢）串成一條自動化流水線，讓內容站從『寫爽的部落格』變成有佣金數字可看的資產。
- [本機桌面 RPA 代理（Mac App）：讓 AI 直接操作沒有 API 的老系統，把 ERP／報稅／後台對帳流程自動化](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P054/) — 中小企業最貴的重複人力，全卡在那些沒有 API、也不會有 API 的舊系統上；與其等廠商開接口，不如讓一個本機 AI agent 看著螢幕把流程跑完，帳號密碼與資料完全不離開公司電腦。
- [鏈上聰明錢研究台（本機自架）：追蹤 Solana 高勝率錢包，把「誰在買什麼」變成可回測、可告警的研究訊號](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P055/) — 鏈上所有交易都是公開的，但九成散戶只會在群組裡聽人喊單；這套工具把「找出長期真的有賺的錢包 → 統計它們的進出場特徵 → 回測跟隨這批錢包的歷史績效 → 即時告警」做成一條可驗證的研究流水線，只做研…
- [跨境電商 AI 私域客服中台：售前售後對話、WhatsApp／IG 私訊行銷、合規排程一次包，把客服成本轉成回購營收](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P056/) — 把電商賣家最痛也最貴的那一段——每天幾百則「什麼時候到貨」「可以退嗎」「有沒有折扣」——交給 AI 全自動應答，同時把每一次對話變成可再行銷的私域名單，用合規的排程把促購訊息推回去，讓客服部門從純成…
- [台灣公開資料 MCP 中樞：把政府開放資料與在地公用 API 一次打包成 AI agent 直接可呼叫的工具集](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P057/) — 巴西社群把七十個國家級公開 API 包成一台 MCP 伺服器、拿下一千六百顆星，證明「單一國家的公開資料 MCP」是被驗證過的需求；本案把同一套做法搬到台灣，讓開發者與企業的 AI agent 一行…
- [小紅書種草內容中台：關鍵字選題 → 繁中／簡中筆記文案＋封面圖 → 人工確認後發佈與數據回收，一人維運多個帶貨帳號](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P058/) — 小紅書是華語圈目前轉換率最高的圖文種草場，但它的內容規則和其他平台完全不同——標題吃搜尋關鍵字、首圖決定八成點擊、正文要像真人分享而不是廣告，所以「一稿多平台分發」在這裡一定失效；本案圍繞今日新上榜…
- [AI 郵件商機管家：把塞爆的收件匣變成不漏接的跟進清單，每一封往來自動長成這個客戶的長期記憶](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P059/) — 中小企業與接案者真正漏掉的錢，多半不是沒有詢價，而是詢價信被淹在收件匣裡、或是回了第一封之後就忘了追；本案把今日上榜、提供二十七個郵件工具的 agent-kit 當成手腳，配上開源記憶系統 memU…
- [產品上線冷啟動引擎：新站新 App 的第一個月，自動鋪滿三百個目錄並算清每個管道真正帶來多少人](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P060/) — 獨立開發者與小型 SaaS 團隊做完產品之後最常卡住的不是行銷創意，而是「該去哪裡曝光、鋪了以後根本不知道哪一個有用」這兩件苦工；本案把今日上榜、收錄三百多個可提交目錄的 awesome-submi…
- [本機即時雙語字幕台：直播、線上課與跨國會議一開口就出字幕，聲音全程不離開這台電腦](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P061/) — 現有的即時字幕與同步口譯服務幾乎都要把麥克風音訊送上雲端，這讓法務、醫療、金融與政府單位的跨國會議根本不能用，而直播主與線上課講師則卡在按分鐘計價的成本上；本案把今日上榜、專為即時語音轉文字設計的串…
- [App 上架素材工作室：從暢銷 App 版型生出原生級畫面 → 自動產 App Store／Google Play 截圖與預覽影片，給獨立開發者的一條龍上架包](https://cenxialiu7-cloud.github.io/ai-oss-daily/proposals/P062/) — 獨立開發者最常卡在「App 做完了，但畫面不像暢銷款、上架截圖和預覽影片又得另外找設計師」；本案用今日上榜的 appllama-skills 把暢銷 App 的版型模式直接生成原生品質的 React…
