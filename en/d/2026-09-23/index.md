# AI OSS Daily · 2026-09-23

_Daily archive · 2026-09-23_
...
- [hypit-ai/hypit](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/hypit-ai-hypit/) (+1,041★)
- [deepseek-ai/deepseek-harness](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/deepseek-ai-deepseek-harness/) (+868★)
- [tt-a1i/archify](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/tt-a1i-archify/) (+655★)
- [DietrichGebert/ponytail](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/dietrichgebert-ponytail/) (+585★)
- [ayghri/i-have-adhd](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/ayghri-i-have-adhd/) (+414★)
- [alibaba/open-code-review](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/alibaba-open-code-review/) (+399★)
...
- [fastino/gliner2.5-multi-v1](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/model-fastino-gliner2-5-multi-v1/) — token-classification · gliner2, safetensors, extractor
...
- [r0b0tlab/deepseek-v4-pro-0813-agentic](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/dataset-r0b0tlab-deepseek-v4-pro-0813-agentic/) — · task_categories:text-generation, task_categories:question-answering, task_categories:other
...
- [jacokon/fasth3-live](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/dataset-jacokon-fasth3-live/) — · language:en, license:other, modality:text
...
- [ARPAHLS/avatar](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/arpahls-avatar/) — VRM companion that lipsyncs and animates to AI, local LLMs, or any audio - desktop overlay & browser.
...
- [ArturSepp/TrendFollowingSystems](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/artursepp-trendfollowingsystems/) — Closed-form trend-following analytics, reference system implementations, and reproducible futures evidence in…
...
- [sonhany/XuanJiQuant](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/sonhany-xuanjiquant/) — 璇玑 XUANJI · AI 自主进化 A 股量化模拟盘系统 — 覆盖数据采集→因子计算→策略回测→模拟执行→风控监控→AI自主调度/复盘完整闭环。五层AI Agent架构，硬风控+白名单执行，可审计可回滚。
...
- [laion/BVD-V-55M](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/dataset-laion-bvd-v-55m/) — · size_categories:10M<n<100M, arxiv:2608.24845, region:us
...
- [baskduf/FableCodex](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/baskduf-fablecodex/) — 🗿 FableCodex is a Codex-style coding agent workflow that plans like Fable.
...
- [FRS2003/hands-on-llm](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/frs2003-hands-on-llm/) — 动手学大模型全栈：CS336 中文精讲 · PyTorch 手搓 Transformer · 单卡复现 Pretrain/SFT/LoRA/DPO/GRPO/RLVR · PEFT/Agent/RAG 落地（含真实实验…
...
- [lj22503/awesome-finai-tools-zn](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/lj22503-awesome-finai-tools-zn/) — 中国金融 AI 工具全景图：Market Data MCP / 量化框架 / 券商 Skills / 金融 CLI / Python 金融库。覆盖 A股 港股 基金 期货 行情数据 量化回测 因子挖掘 舆情分析 投研。…
...
- [ilang-ai/autocode](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/ilang-ai-autocode/) — You say it. AutoCode ships it. 48 skills. Code to deployment in one session. iLang v5.0 judgment + secret-saf…
...
- [michael-denyer/pstack-claude](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/michael-denyer-pstack-claude/) — Claude Code, Codex, OpenCode, Gemini, and Prime Agent versions of Poteto's pstack. Rigorous agent workflows w…
...
- [Laurent00TT/PharosRAG](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/laurent00tt-pharosrag/) — Pharos — local-first agentic RAG for your team's document library: multi-format ingest, hybrid retrieval, ent…
...
- [CodNoob100/null-drift](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/codnoob100-null-drift/) — null-drift 是一個基於 Hyperdimensional 計算的認知架構，支援機器學習和 LangGraph。
...
- [coral870921-source/Ozon-Profit-Skills](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/coral870921-source-ozon-profit-skills/) — 🛒 Claude Code skills for cross-border e-commerce automation. Auto-translate listings into any language, gener…
...
- [zjunlp/LightRSI](https://cenxialiu7-cloud.github.io/ai-oss-daily/en/p/zjunlp-lightrsi/) — [EMNLP 2026] LightRSI is a modular runtime for lightly deploying recursive self-improvement loops in long-hor…
